...
#define DELTA
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 160.0 - 8.40// mm
...
#define DISABLE_E false // For all extruders  --TOT Why did I set to false?
...
// #define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 0.0   // Probe on: -front +behind
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 302.1 - 1.5 + 4.0 - 4.35 + 0.1// For delta: Distance between nozzle and print surface after homing.
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 150}  //ORG: #deffine DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 760*1.1}  // default steps per unit for Kossel (GT2, 20 tooth)
